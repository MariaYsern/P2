...
typedef enum {ST_UNDEFV=0, ST_UNDEFS=1, ST_SILENCE, ST_VOICE, ST_INIT} VAD_STATE;
...
VAD_DATA *vad_open(float sampling_rate, float alfa0, float alfa1, float alfa2, float timeleft_init);
